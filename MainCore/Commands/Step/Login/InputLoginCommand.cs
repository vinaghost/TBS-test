...
{
    [RegisterAsTransient]
    public class InputLoginCommand : IInputLoginCommand
    {
        private readonly IChromeManager _chromeManager;
        private readonly IUnitOfParser _unitOfParser;
        private readonly IUnitOfRepository _unitOfRepository;

        public InputLoginCommand(IChromeManager chromeManager, IUnitOfRepository unitOfRepository, IUnitOfParser unitOfParser)
        {
